...
| Text-GAN | Discriminator Accuracy ≈ 57-67% | BLEU = 0.0, ROUGE-1 = 0.129 | Stable adversarial balance; less coherent output than GPT-2 due to no pretraining and simpler vocabulary |
